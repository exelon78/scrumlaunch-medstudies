...
data "google_container_cluster" "gke_cluster" {
  ...
  project  = "scrum-launch1-dev-apps"
}
...
data "google_secret_manager_secret_version" "secrets" {
  ...
  project  = "scrum-launch1-dev-secrets"
  secret   = each.key
...
resource "kubernetes_secret" "shared_secrets" {
  ...
  data = {
    consent_bucket_name               = "scrum-launch1-dev-mystudies-consent-documents"
    study_resources_bucket_name       = "scrum-launch1-dev-mystudies-study-resources"
    study_export_import_bucket_name   = "scrum-launch1-dev-mystudies-sql-import"
    institution_resources_bucket_name = "scrum-launch1-dev-mystudies-institution-resources"
    base_url                          = "https://participants.scrum-launch1-dev.providencemt.com"
    studies_base_url                  = "https://studies.scrum-launch1-dev.providencemt.com"
    firestore_project_id              = "scrum-launch1-dev-firebase"
...
resource "google_service_account_key" "apps_service_account_keys" {
  ...
  service_account_id = "${each.key}@scrum-launch1-dev-apps.iam.gserviceaccount.com"
}
