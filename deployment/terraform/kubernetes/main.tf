...
resource "kubernetes_secret" "shared_secrets" {
  ...
  data = {
    consent_bucket_name               = "scrumlaunch2-dev-mystudies-consent-documents"
    study_resources_bucket_name       = "scrumlaunch2-dev-mystudies-study-resources"
    study_export_import_bucket_name   = "scrumlaunch2-dev-mystudies-sql-import"
    institution_resources_bucket_name = "scrumlaunch2-dev-mystudies-institution-resources"
    base_url                          = "https://participants.scrumlaunch2-dev.providencemt.com"
    studies_base_url                  = "https://studies.scrumlaunch2-dev.providencemt.com"
    firestore_project_id              = "scrumlaunch2-dev-firebase"
...
resource "google_service_account_key" "apps_service_account_keys" {
  ...
  service_account_id = "${each.key}@scrumlaunch2-dev-apps.iam.gserviceaccount.com"
}
