...
terraform {
  ...
  backend "gcs" {
    ...
    prefix = "scrum-launch1-dev-firebase"
  }
}
...
module "project" {
  ...
  name                    = "scrum-launch1-dev-firebase"
  org_id                  = ""
...
module "scrum_launch1_dev_mystudies_firestore_raw_data" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "scrum-launch1-dev-mystudies-firestore-raw-data"
  project_id = module.project.project_id
