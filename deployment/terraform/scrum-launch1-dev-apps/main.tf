...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/scrum-launch1-dev-networks/regions/us-central1/subnetworks/scrum-launch1-dev-gke-subnet",
  ]
  activate_apis = [
...
module "scrum_launch1_dev" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "scrum-launch1-dev"
  project_id = module.project.project_id
  domain     = "scrum-launch1-dev.providencemt.com."
  type       = "public"
...
module "scrum_launch1_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "scrum-launch1-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-central1"
  regional           = true
  network_project_id = "scrum-launch1-dev-networks"

  network                 = "scrum-launch1-dev-network"
  subnetwork              = "scrum-launch1-dev-gke-subnet"
  ip_range_pods           = "scrum-launch1-dev-pods-range"
  ip_range_services       = "scrum-launch1-dev-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@scrum-launch1-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
