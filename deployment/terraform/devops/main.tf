...
module "state_bucket" {
  ...
  name       = "scrum-launch1-dev-terraform-state"
...
resource "google_project_iam_binding" "devops_owners" {
  ...
  role    = "roles/owner"
  members = ["group:scrum-launch1-dev-devops-owners@providencemt.com"]
}
...
resource "google_folder_iam_member" "admin" {
  ...
  member = "group:scrum-launch1-dev-folder-admins@providencemt.com"
}
