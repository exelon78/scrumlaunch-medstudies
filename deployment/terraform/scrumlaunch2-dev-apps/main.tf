...
#7#   github {
#7#     owner = "exelon78"
#7#     name  = "scrumlaunch-medstudies"
#7#     push { branch = "^2.0.8-terraform-&-read-me-changes$" }
#7#   }
...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/scrumlaunch2-dev-networks/regions/us-central1/subnetworks/scrumlaunch2-dev-gke-subnet",
  ]
  activate_apis = [
...
module "scrumlaunch2_dev" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "scrumlaunch2-dev"
  project_id = module.project.project_id
  domain     = "scrumlaunch2-dev.providencemt.com."
  type       = "public"
...
module "scrumlaunch2_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "scrumlaunch2-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-central1"
  regional           = true
  network_project_id = "scrumlaunch2-dev-networks"

  network                 = "scrumlaunch2-dev-network"
  subnetwork              = "scrumlaunch2-dev-gke-subnet"
  ip_range_pods           = "scrumlaunch2-dev-pods-range"
  ip_range_services       = "scrumlaunch2-dev-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@scrumlaunch2-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
