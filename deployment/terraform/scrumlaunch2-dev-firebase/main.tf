...
terraform {
  ...
  backend "gcs" {
    ...
    prefix = "scrumlaunch2-dev-firebase"
  }
}
...
module "project" {
  ...
  name                    = "scrumlaunch2-dev-firebase"
  org_id                  = ""
...
module "scrumlaunch2_dev_mystudies_firestore_raw_data" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "scrumlaunch2-dev-mystudies-firestore-raw-data"
  project_id = module.project.project_id
